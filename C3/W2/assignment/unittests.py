...
def test_train_val_datasets(learner_func):
    def g():
        ...
        data = np.loadtxt('../../W1/assignment/data/bbc-text.csv', delimiter=',', skiprows=1, dtype='str', comments=None)
        t = test_case()
        try:
...
def test_fit_label_encoder(learner_func):
    def g():
        ...
        t = test_case()
        labels_arr = np.loadtxt('../../W1/assignment/data/bbc-text.csv', delimiter=',', skiprows=1, dtype='str', usecols=0, comments=None)
